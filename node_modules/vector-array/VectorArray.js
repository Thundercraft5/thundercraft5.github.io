...
export default class VectorArray extends Array {
	static Entry = class Entry {
		...
		* [Symbol.iterator]() {
		...
		toString() { return `Map.Entry(${ String(this.#x) } => ${ String(this.#y) })`; }
	};
	...
	indexOf(x, y) {
		return super.findIndex(([x1, y1]) => x1 === x && y1 === y);
	}
	...
	deleteAll(...entries) {
		return entries.map(e => typeof e === 'number' ? this.deleteByIndex(e) : this.delete(e));
	}
	...
	removeAll(...entries) {
		return entries.map(e => typeof e === 'number' ? this.removeByIndex(e) : this.remove(e));
	}
...
VectorArray.prototype[Symbol.species] = VectorArray;