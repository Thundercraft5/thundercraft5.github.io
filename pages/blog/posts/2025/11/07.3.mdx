...
They will then form galls which divert nutrients from the vine to allow only themselves to reproduce. 
My host had not yet encountered this specific anomaly on the farm, so I was grateful that my habit of deep observation allowed me to catch it early on! Admittedly both of us made lots of errors like not keeping the shears clean and me misidentifying it as a type of fungus gall rather than bacteria, but my host eventually called his friend and pinned down the problem.
