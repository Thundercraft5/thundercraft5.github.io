	...
	assignMethods: { // Test
		value: {
			assignMethods(targetObject, methods = {}, rawAssign = false) {
				if (!rawAssign && typeof methods !== "object")
					if (typeof targetObject !== "function")
						throw new TypeError("Target object must be a class or function");

				if (!rawAssign)
					if (!targetObject.prototype)
						throw new TypeError("Target object must have a prototype");
