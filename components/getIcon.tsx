export const icons = ["JS", "Lua", "Obsidian", "Chrome", "GitHub", "TS", "Local"] as const;
export type Icon = (typeof icons)[number];


import { ComponentError } from "../src/util/errors";
import { GithubIcon, JavaScriptIcon, LuaIcon, ChromeIcon, ObsidianIcon, LocalIcon } from "./icons";
